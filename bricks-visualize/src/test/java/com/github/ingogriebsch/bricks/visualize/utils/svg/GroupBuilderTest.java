...
public class GroupBuilderTest {
    ...
    public void builder_should_throw_exception_if_input_is_null() {
        assertThrows(NullPointerException.class, () -> GroupBuilder.builder(null));
    }

    @Test
    public void build_should_return_builder() {
        assertThat(GroupBuilder.builder(document)).isNotNull();
    }

    @Test
    public void build_should_return_matching_element() {
        GroupBuilder builder = GroupBuilder.builder(document);
        assertThat(builder.build()).isNotNull().isInstanceOf(SVGGElement.class);
    }
