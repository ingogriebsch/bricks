...
public class SpringResourceBasedApplicationResourceLoader extends AbstractSpringResourceBasedResourceLoader
    implements ApplicationResourceLoader {

    public SpringResourceBasedApplicationResourceLoader(ResourceLoader resourceLoader,
